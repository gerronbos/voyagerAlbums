        ...
        <div class="panel panel-bordered">
            <div class="panel-body">
                ...
                <select class="form-control type" name="type">
                    ...
                    <option value="path">Geuploade album</option>
                </select>


                <div class="fb_div show_type" style="display:none;">
                    <div class="alert alert-info" role="alert">Werkt nog niet...</div>
                </div>

                <div class="path_div show_type" style="display:none; height:250px;">
                    <select class="selectpicker" name="album_path">
                        <option>Select...</option>
                        @foreach($normal_albums as $album)
                            <option data-thumbnail="{{$album["thumb"]}}" value="{{$album['path']}}">{{$album["name"]}}</option>
                        @endforeach
                    </select>   
                </div>
